...
#
# Generated by export_simulation on Sun Dec 09 13:20:19 EST 2018
#
################################################################################
...
'-reset_run' switch to the './lenetSynthMatlab_0.sh' script.

./lenetSynthMatlab_0.sh -reset_run
...
./lenetSynthMatlab_0.sh -noclean_files

For more information on the script, please type './lenetSynthMatlab_0.sh -help'.
