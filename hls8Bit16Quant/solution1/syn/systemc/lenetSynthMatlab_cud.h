...
#ifndef __lenetSynthMatlab_cud__HH__
#define __lenetSynthMatlab_cud__HH__
...
SC_MODULE(lenetSynthMatlab_cud) {
    ...
    ACMP_urem_seq<ID, 12, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_urem_seq_U;

    SC_CTOR(lenetSynthMatlab_cud):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
