...
#ifndef __lenetSynthMatlab_bkb__HH__
#define __lenetSynthMatlab_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenetSynthMatlab_bkb) {
    ...
    ACMP_urem_seq<ID, 9, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_urem_seq_U;

    SC_CTOR(lenetSynthMatlab_bkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
