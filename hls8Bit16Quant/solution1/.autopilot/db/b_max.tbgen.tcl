...
set C_modelName {b_max}
set C_modelType { void 0 }
set C_modelArgList {
	{ b_y0 int 16 regular {array 4704 { 1 3 } 1 1 }  }
	{ maxval int 16 regular {array 4704 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ b_y0_address0 sc_out sc_lv 13 signal 0 } 
	{ b_y0_ce0 sc_out sc_logic 1 signal 0 } 
	{ b_y0_q0 sc_in sc_lv 16 signal 0 } 
	{ maxval_address0 sc_out sc_lv 13 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "b_y0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "b_y0", "role": "address0" }} , 
 	...
 	{ "name": "maxval_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "maxval", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15737", "Max" : "15737"}
	, {"Name" : "Interval", "Min" : "15737", "Max" : "15737"}
]}
...
set Spec2ImplPortList { 
	b_y0 { ap_memory {  { b_y0_address0 mem_address 1 13 }  { b_y0_ce0 mem_ce 1 1 }  { b_y0_q0 mem_dout 0 16 } } }
	maxval { ap_memory {  { maxval_address0 mem_address 1 13 }  { maxval_ce0 mem_ce 1 1 }  { maxval_we0 mem_we 1 1 }  { maxval_d0 mem_din 1 16 } } }
}
