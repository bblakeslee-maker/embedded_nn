...
set C_modelName {g_sum}
set C_modelType { void 0 }
set C_modelArgList {
	{ X int 64 regular {array 80 { 1 3 } 1 1 }  }
	{ Y int 64 regular {array 16 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenetSynthMatlab_g8j_U38", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "241", "Max" : "881"}
	, {"Name" : "Interval", "Min" : "241", "Max" : "881"}
]}
...
set Spec2ImplPortList { 
	X { ap_memory {  { X_address0 mem_address 1 7 }  { X_ce0 mem_ce 1 1 }  { X_q0 mem_dout 0 64 } } }
	Y { ap_memory {  { Y_address0 mem_address 1 4 }  { Y_ce0 mem_ce 1 1 }  { Y_we0 mem_we 1 1 }  { Y_d0 mem_din 1 64 } } }
}
