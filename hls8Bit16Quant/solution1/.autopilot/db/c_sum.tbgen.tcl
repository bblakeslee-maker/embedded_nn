...
set C_modelName {c_sum}
set C_modelType { void 0 }
set C_modelArgList {
	{ X int 1 regular {array 150 { 1 3 } 1 1 }  }
	{ Y int 64 regular {array 30 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ Y_address0 sc_out sc_lv 5 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenetSynthMatlab_cud_U7", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenetSynthMatlab_dEe_U8", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenetSynthMatlab_dEe_U9", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenetSynthMatlab_eOg_U10", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenetSynthMatlab_eOg_U11", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "781", "Max" : "2311"}
	, {"Name" : "Interval", "Min" : "781", "Max" : "2311"}
]}
...
set Spec2ImplPortList { 
	X { ap_memory {  { X_address0 mem_address 1 8 }  { X_ce0 mem_ce 1 1 }  { X_q0 mem_dout 0 1 } } }
	Y { ap_memory {  { Y_address0 mem_address 1 5 }  { Y_ce0 mem_ce 1 1 }  { Y_we0 mem_we 1 1 }  { Y_d0 mem_din 1 64 } } }
}
