...
#
# Generated by export_simulation on Mon Dec 10 15:32:10 EST 2018
#
################################################################################
...
'-reset_run' switch to the './lenetSynthMatlab_fixpt_0.sh' script.

./lenetSynthMatlab_fixpt_0.sh -reset_run
...
./lenetSynthMatlab_fixpt_0.sh -noclean_files

For more information on the script, please type './lenetSynthMatlab_fixpt_0.sh -help'.
