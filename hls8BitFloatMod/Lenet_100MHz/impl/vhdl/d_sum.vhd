...
architecture behav of d_sum is 
    ...
    signal tmp_168_reg_265 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_166_fu_196_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_167_fu_201_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal tmp_171_fu_133_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal p_shl_fu_137_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_172_fu_149_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_165_fu_191_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_169_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                y_addr_4_reg_250 <= tmp_167_fu_201_p1(3 - 1 downto 0);
            end if;
        end if;
    end process;
    ...
    p_shl9_cast_fu_155_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_172_fu_149_p2),6));
    p_shl_cast_fu_145_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_shl_fu_137_p3),6));
    p_shl_fu_137_p3 <= (tmp_171_fu_133_p1 & ap_const_lv3_0);
    ...
    tmp_165_fu_191_p2 <= std_logic_vector(unsigned(tmp1_cast_fu_187_p1) + unsigned(tmp_s_reg_232));
    tmp_166_fu_196_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_165_fu_191_p2),64));
    tmp_167_fu_201_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(b_k_reg_89),64));
    tmp_171_fu_133_p1 <= k_1_reg_78(2 - 1 downto 0);
    tmp_172_fu_149_p2 <= std_logic_vector(shift_left(unsigned(k_1_reg_78),to_integer(unsigned('0' & ap_const_lv3_1(3-1 downto 0)))));
    ...
    x_address0_assign_proc : process(ap_CS_fsm_state2, tmp_fu_116_p1, ap_CS_fsm_state5, tmp_166_fu_196_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            x_address0 <= tmp_166_fu_196_p1(5 - 1 downto 0);
    ...
    y_address0_assign_proc : process(tmp_reg_214, ap_CS_fsm_state5, y_addr_4_reg_250, ap_CS_fsm_state3, ap_CS_fsm_state12, tmp_167_fu_201_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
            y_address0 <= y_addr_4_reg_250;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            y_address0 <= tmp_167_fu_201_p1(3 - 1 downto 0);
    ...
    y_d0_assign_proc : process(x_q0, tmp_168_reg_265, ap_CS_fsm_state3, ap_CS_fsm_state12)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
