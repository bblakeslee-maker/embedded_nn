...
wire   [63:0] tmp_170_fu_205_p1;
reg   [63:0] tmp_170_reg_384;
...
wire  signed [6:0] tmp_171_fu_294_p2;
reg  signed [6:0] tmp_171_reg_415;
...
wire   [63:0] tmp_173_fu_344_p1;
wire   [63:0] tmp_175_fu_358_p1;
...
wire   [6:0] tmp_169_fu_196_p2;
wire  signed [31:0] tmp_175_cast_fu_201_p1;
wire   [1:0] tmp_177_fu_222_p1;
wire   [6:0] p_shl10_fu_226_p3;
wire   [2:0] tmp_178_fu_238_p2;
...
wire  signed [8:0] tmp_177_cast_fu_300_p1;
wire   [5:0] c_k_cast3_fu_313_p1;
wire   [5:0] tmp2_fu_329_p2;
wire   [8:0] tmp2_cast_fu_335_p1;
wire   [8:0] tmp_172_fu_339_p2;
wire   [6:0] c_k_cast4_fu_309_p1;
wire   [6:0] tmp_174_fu_349_p2;
wire  signed [31:0] tmp_181_cast_fu_354_p1;
reg   [13:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_258_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
        ...
        tmp_171_reg_415[6 : 1] <= tmp_171_fu_294_p2[6 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond3_fu_184_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_170_reg_384[31 : 0] <= tmp_170_fu_205_p1[31 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_317_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
        y_addr_5_reg_438 <= tmp_175_fu_358_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        x_address0 = tmp_173_fu_344_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        x_address0 = tmp_170_fu_205_p1;
    end else begin
        x_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        ...
        y_address0 = tmp_175_fu_358_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        y_address0 = tmp_170_reg_384;
    end else begin
        y_address0 = 'bx;
    end
end
...
assign p_shl10_fu_226_p3 = {{tmp_177_fu_222_p1}, {5'd0}};

assign p_shl11_cast_fu_244_p1 = tmp_178_fu_238_p2;
...
assign tmp1_fu_304_p2 = ($signed(tmp_177_cast_fu_300_p1) + $signed(tmp_cast_reg_402));

assign tmp2_cast_fu_335_p1 = tmp2_fu_329_p2;

assign tmp2_fu_329_p2 = (c_k_cast3_fu_313_p1 + 6'd30);

assign tmp_169_fu_196_p2 = (tmp_reg_371 + b_k_cast7_fu_180_p1);

assign tmp_170_fu_205_p1 = $unsigned(tmp_175_cast_fu_201_p1);

assign tmp_171_fu_294_p2 = (p_shl12_cast_fu_278_p1 - p_shl13_cast_fu_290_p1);

assign tmp_172_fu_339_p2 = (tmp2_cast_fu_335_p1 + tmp1_reg_420);

assign tmp_173_fu_344_p1 = tmp_172_fu_339_p2;

assign tmp_174_fu_349_p2 = ($signed(tmp_171_reg_415) + $signed(c_k_cast4_fu_309_p1));

assign tmp_175_cast_fu_201_p1 = $signed(tmp_169_fu_196_p2);

assign tmp_175_fu_358_p1 = $unsigned(tmp_181_cast_fu_354_p1);

assign tmp_177_cast_fu_300_p1 = tmp_171_fu_294_p2;

assign tmp_177_fu_222_p1 = k_1_reg_101[1:0];

assign tmp_178_fu_238_p2 = k_1_reg_101 << 3'd1;

assign tmp_181_cast_fu_354_p1 = $signed(tmp_174_fu_349_p2);
...
always @ (posedge ap_clk) begin
    tmp_reg_371[0] <= 1'b0;
    tmp_170_reg_384[63:32] <= 32'b00000000000000000000000000000000;
    tmp_cast_reg_402[0] <= 1'b0;
    tmp_171_reg_415[0] <= 1'b0;
    tmp1_reg_420[0] <= 1'b0;
end
