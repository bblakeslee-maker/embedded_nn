...
set C_modelArgList {
	{ x float 32 regular {array 400 { 1 3 } 1 1 }  }
	{ y float 32 regular {array 80 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenetSynthMatlab_bkb_U11", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "860", "Max" : "860"}
	, {"Name" : "Interval", "Min" : "860", "Max" : "860"}
]}
...
set Spec2ImplPortList { 
	...
	y { ap_memory {  { y_address0 mem_address 1 7 }  { y_ce0 mem_ce 1 1 }  { y_we0 mem_we 1 1 }  { y_d0 mem_din 1 32 }  { y_q0 mem_dout 0 32 } } }
}
