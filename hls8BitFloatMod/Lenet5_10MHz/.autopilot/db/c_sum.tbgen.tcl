...
set C_modelArgList {
	{ x float 32 regular {array 150 { 1 3 } 1 1 }  }
	{ y float 32 regular {array 30 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenetSynthMatlab_bkb_U5", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "360", "Max" : "360"}
	, {"Name" : "Interval", "Min" : "360", "Max" : "360"}
]}
...
set Spec2ImplPortList { 
	...
	y { ap_memory {  { y_address0 mem_address 1 5 }  { y_ce0 mem_ce 1 1 }  { y_we0 mem_we 1 1 }  { y_d0 mem_din 1 32 }  { y_q0 mem_dout 0 32 } } }
}
