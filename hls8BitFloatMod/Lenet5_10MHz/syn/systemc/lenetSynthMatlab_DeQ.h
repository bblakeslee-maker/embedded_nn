...
#ifndef __lenetSynthMatlab_DeQ__HH__
#define __lenetSynthMatlab_DeQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenetSynthMatlab_DeQ) {
    ...
    SC_CTOR(lenetSynthMatlab_DeQ):  ACMP_fmul_comb_U ("ACMP_fmul_comb_U") {
