...
#ifndef __lenetSynthMatlab_Ffa__HH__
#define __lenetSynthMatlab_Ffa__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenetSynthMatlab_Ffa) {
    ...
    SC_CTOR(lenetSynthMatlab_Ffa):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
