...
open_solution "Lenet5_50MHz"
set_part {xc7a100tcsg324-1}
create_clock -period 20 -name default
#source "./hls8BitFloatMod/Lenet5_50MHz/directives.tcl"
csim_design
csynth_design
cosim_design
export_design -flow impl -rtl vhdl -format ip_catalog -description "LeNet5 running at 50MHz." -vendor "BryanBlakeslee" -library "Lenet5"
